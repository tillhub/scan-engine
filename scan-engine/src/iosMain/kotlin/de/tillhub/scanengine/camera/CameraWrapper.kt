...
internal class CameraWrapperImpl(
    ...
    override fun setupPreviewLayer(view: UIView) {
        captureSession?.let { session ->
            val newPreviewLayer =
                captureFactory.getCaptureVideoPreviewLayer(
                    session = session,
                    view = view,
     ...
     */
    override fun addOutputIfPossible(output: CaptureMetadataOutput): Boolean? = captureSession?.addOutputIfPossible(output)
